        ...
        <section className="bread-crumb">
          <div className="container">
            <div className="title-command-wrapper">
              <h2 className="title" title="Tin tức">
                Tin tức
              </h2>
              <ul
          ...
          <div className="row">
            <section className="right-content col-md-9 col-md-push-3">
              ...
              <section className="list-blogs blog-main">
                <div className="row">
                  <div className="col-md-4 col-sm-6 col-xs-6 col-100">
                    <article className="blog-item">
                      <div className="blog-item-thumbnail">
                        <a href="/cho-thue-kho">
                          <div
                            className="blog-link__featured-image"
                            style={{
                              backgroundImage:
                                "url(//bizweb.dktcdn.net/thumb/grande/100/472/220/articles/anh-k2.jpg?v=1685173933857)",
                            }}
                          />
                        </a>
                      </div>
                  ...
                  <div className="col-md-4 col-sm-6 col-xs-6 col-100">
                    <article className="blog-item">
                      <div className="blog-item-thumbnail">
                        <a href="/van-chuyen-hang-hoa-la-gi-1">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                "url(//bizweb.dktcdn.net/thumb/grande/100/472/220/articles/tnc-slide-3.jpg?v=1685173638267)",
                            }}
                          />
                        </a>
                      </div>
                      ...
                      <div className="post-time">
                        25/05/2023 - CÔNG TY TNHH DỊCH VỤ KHO VẬN TOÀN NHẤT
                      </div>
                      <p className="blog-item-summary margin-bottom-5">
                        Vận chuyển hàng hóa&nbsp;là một trong những hoạt động
                        kinh doanh vô cùng quan...
                      </p>
                    </article>
                  </div>
                  <div className="col-md-4 col-sm-6 col-xs-6 col-100">
                      ...
                      <div className="blog-item-thumbnail">
                        <a href="/gui-hang-noi-dia">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                "url(//bizweb.dktcdn.net/thumb/grande/100/472/220/articles/anh-g2.jpg?v=1685173867917)",
                            }}
                          />
                        </a>
                      </div>
                  ...
                  <div className="col-md-4 col-sm-6 col-xs-6 col-100">
                    <article className="blog-item">
                      <div className="blog-item-thumbnail">
                        <a href="/dich-vu-van-chuyen-1">
                          <div
                            className="blog-link__featured-image"
                            style={{
                              backgroundImage:
                                "url(//bizweb.dktcdn.net/thumb/grande/100/472/220/articles/tnc7.jpg?v=1684910909070)",
                            }}
                          />
                        </a>
                      </div>
                      ...
                      <div className="post-time">
                        24/05/2023 - CÔNG TY TNHH DỊCH VỤ KHO VẬN TOÀN NHẤT
                      </div>
                      <p className="blog-item-summary margin-bottom-5">
                        Vận chuyển hàng hóa nội địa là một nhu cầu thường
                        xuyên&nbsp;của người dân, l...
                      </p>
                    </article>
                  </div>
                  <div className="col-md-4 col-sm-6 col-xs-6 col-100">
                    <article className="blog-item">
                      <div className="blog-item-thumbnail">
                        <a href="/nhung-luu-y-khi-chon-dich-vu-van-tai">
                          <div
                            className="blog-link__featured-image"
                            style={{
                              backgroundImage:
                                "url(//bizweb.dktcdn.net/thumb/grande/100/472/220/articles/nhung-luu-y-khi-chon-dich-vu-van-tai-hinh-2.jpg?v=1670550713173)",
                            }}
                          />
                        </a>
                      </div>
                      ...
                      <div className="post-time">
                        09/12/2022 - CÔNG TY TNHH DỊCH VỤ KHO VẬN TOÀN NHẤT
                      </div>
                      <p className="blog-item-summary margin-bottom-5">
                        Vận tải hàng hóa là một vấn đề rất quan trọng đối với
                        một doanh nghiệp sản xu...
                      </p>
                    </article>
                  </div>
                  <div className="col-md-4 col-sm-6 col-xs-6 col-100">
                    <article className="blog-item">
                      <div className="blog-item-thumbnail">
                        <a href="/top-6-giai-phap-cong-nghe-trong-dich-vu-van-chuyen-uy-tin">
                          <div
                            className="blog-link__featured-image"
                            style={{
                              backgroundImage:
                                "url(//bizweb.dktcdn.net/thumb/grande/100/472/220/articles/giai-phap-toi-uu-tu-dong-hoa-chuoi-cung-ung-dich-vu-van-chuyen-uy-tin.jpg?v=1670550518693)",
                            }}
                          />
                        </a>
                      </div>
                      ...
                      <p className="blog-item-summary margin-bottom-5">
                        Để đáp ứng nhu cầu ngày càng tăng trong lĩnh vực chuyển
                        phát&nbsp;giao hàng n...
                      </p>
                    </article>
                  </div>
