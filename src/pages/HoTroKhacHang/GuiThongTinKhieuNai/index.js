...
export default function GuiKhieuNai() {
  return (
    <div>
      <section className="bread-crumb">
        <div className="container">
          <div className="title-command-wrapper">
            <h2 className="title" title="Gửi thông tin khiếu nại">
            ...
            >
              ...
              <li
                ...
                itemType="https://schema.org/ListItem"
              >
                <strong itemProp="name">Gửi thông tin khiếu nại</strong>
          ...
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-12">
              <div className="page-title category-title">
                <h1 className="title-head">Gửi thông tin khiếu nại</h1>
              </div>
